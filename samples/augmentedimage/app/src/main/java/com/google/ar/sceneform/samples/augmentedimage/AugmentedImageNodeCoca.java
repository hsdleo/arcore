...
public class AugmentedImageNodeCoca extends AnchorNode {
  ...
  private static CompletableFuture<ModelRenderable> cocaRender;

  public AugmentedImageNodeCoca(Context context) {
  ...
  public void setImage(AugmentedImage image) {
    ...
    if (!cocaRender.isDone()) {
      CompletableFuture.allOf(cocaRender)
    ...
    cornerNode.setRenderable(cocaRender.getNow(null));
    /*
    // Upper left corner.
